        ...
        <div className="flex-1 flex flex-col min-h-screen">
            ...
            <main className={`p-4 sm:p-8 flex-1 overflow-auto ${darkMode ? 'bg-[#0a0a0a]' : 'bg-white'}`}>
                <div className="max-w-4xl mx-auto">
                    <h2 className={`text-2xl font-bold mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Analytics Dashboard</h2>
                    <p className={`${darkMode ? 'text-zinc-400' : 'text-gray-600'}`}>This is where you can view your analytics data.</p>
                </div>
            </main>
        </div>
    );
